...
function applyFixedData(member) {
  ...
  return {
    ...
    memberColors: member.memberColors || fixedMeta.memberColors || [],
    memberColorLabels: member.memberColorLabels || fixedMeta.memberColorLabels || [],
    badges: {
      ...badges,
